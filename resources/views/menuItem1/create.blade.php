<x-layout>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Tambah Item di Menu</h1>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('menuItem1.store') }}" method="POST" class="user">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-user" id="description" name="description" rows="3" required></textarea>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <label for="price">Harga</label>
                                <input type="number" class="form-control form-control-user" id="price"
                                    name="price" placeholder="hanya angka" required>
                            </div>
                            <div class="col-sm-6">
                                <label for="category">Kategori</label>
                                <input type="text" class="form-control form-control-user" id="category"
                                    name="category" placeholder="kategori" required>
                            </div>
                        </div>
                        <div class="form-group">
